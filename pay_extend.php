...
<tr><td colspan="2">
Детальный разбор резюме: <b><?=$sum?></b> руб.
</td>
...
Описание: Детальный разбор Вашего резюме с HR-экспертом. <br> Плюс 7 дней консультаций по email, без ограничения по количеству вопросов.<br>
