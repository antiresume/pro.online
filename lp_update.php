...
$new_rezume = RandValue(50,10); // увеличиваем количество сегоднящних резюме рандомно в диапазоне от 1 до 5
$new_questions = RandValue(150, 10); // увеличиваем количество сегоднящних вопросов рандомно в диапазоне от 1 до 8
$new_request = RandValue(90, 10); // увеличиваем количество сегоднящних заявок рандомно в диапазоне от 1 до 5
