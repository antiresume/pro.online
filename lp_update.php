...
$new_rezume = RandValue(150,5); // увеличиваем количество сегоднящних резюме рандомно в диапазоне от 1 до 5
$new_questions = RandValue(350, 5); // увеличиваем количество сегоднящних вопросов рандомно в диапазоне от 1 до 8
$new_request = RandValue(290, 5); // увеличиваем количество сегоднящних заявок рандомно в диапазоне от 1 до 5
