		...
		//if($type == "free") {
				...
				<body>
					<div style="width: 660px;">
						Добрый день!<br>
						<br>
						Меня зовут Роман, я эксперт сервиса <a href="http://Правильное-Резюме.онлайн?r1=email&r2=welcome">Правильное-Резюме.онлайн</a>.<br>
						<br>
						...
						8. Что писать в сопроводительном письма?<br>
						9. Что в моем резюме не привлекательно?<br>
						10. Готово ли мое резюме для отправки работодателю?<br>
						<br>
						или что-то еще - просто опишите свою ситуацию и я постараюсь Вам помочь.	<br>
					<br>
						<br>
