<?
	...
	if (isset($_GET['action']) && $_GET['action']=='send_form'){
		...
		//send to Client
				...
				$to  = $email;
				$from  =  "Правильное резюме <crm@antiresu.me>";		
...
*/
				...
				<body>
					<div style="width: 660px;">
						Добрый день!<br>
						<br> 
						Меня зовут Роман, я руководитель сервиса Правильное-резюме.онлайн.<br>
						<br> 
						Наш сервис позволяет проводить экспресс-оценку резюме HR-экспертом.<br>
						Мы настолько уверены в качестве предоставляемых услуг, что берем символический 21 рубль за проделанную работу.<br>
						<br>
						За вами закрепляется персональный HR-эксперт. Вы всегда будете иметь возможность задать уточняющий вопрос и получить квалифицированный ответ.<br>
						<br>
						По результатам работы вы можете поблагодарить наших экспертов любой достойной, на ваш взгляд, суммой.<br>
						Обычно это 1 % от ваших зарплатных ожиданий. При этом 69 % от суммы идет эксперту, 21 % — сервису, и 10 % мы передаем на благотворительные цели.<br>
						<br>					
						Просто отправьте свое резюме ответным письмом (вложением или скопируйте) и сделайте оплату банковской картой с кнопки на главной странице.<br>
						 <br>
						Если Вас волнуют такие вопросы, как:<br>
						1. Почему мало откликов на мое резюме?<br>
						2. Насколько мой опыт и знания подходят желаемой позиции?<br>
						3. Как повысить конкурентоспособность моего резюме?<br>
						4. На какую зарплату можно рассчитывать?<br>
						5. Почему меня не приглашают на собеседования?<br>
						6. Что писать в резюме, чтобы меня пригласили на должность руководителя?<br>
						7. Как быстрее найти работу?<br>
						8. Что писать в сопроводительном письме?<br>
						9. Что в моем резюме выглядит непривлекательно?<br>
						10. Готово ли мое резюме для отправки работодателю?<br>
						 <br>
						или другие вопросы? Задайте их эксперту, опишите свою ситуацию, и получите квалифицированный ответ.<br>
						 <br>
						 <br>
						С наилучшими пожеланиями,<br>
						Роман Петров,<br>
