		...
		//if($type == "free") {
				...
				<body>
					<div style="width: 660px;">
						...
						<br>
						У Вас уже есть резюме? Пришлите мне его, пожалуйста, на этот адрес, либо вложением, либо ссылкой.
						А я отправлю свою экспресс оценку Вашего резюме на правильность.<br>
						<br>
