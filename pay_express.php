...
$APPLICATION->SetTitle("Покупка детализации экспресс оценки");
...
<tr><td colspan="2">
Покупка детализации экспресс оценки: <b><?=$sum?></b> руб.
</td>
...
</td><td width="80%"><span class="text">Банковские карты</span></td></tr>
<tr><td colspan="3" class="text_content">
	
Описание: детализация экспресс оценки с рекомендациями эксперта по улучшению резюме<br>
