...
<tr><td colspan="2">
Правильное резюме с нуля: <b><?=$sum?></b> руб.
</td>
...
Описание: Помощь в написании правильного резюме с нуля. <br>7 дней консультаций по email, без ограничения по количеству вопросов.<br>
